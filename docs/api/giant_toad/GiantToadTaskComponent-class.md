...
# <span class="kind-class">GiantToadTaskComponent\<<span class="type-parameter">C</span>\></span> class
...
<span class="name">[GiantToadTaskComponent](../giant_toad/GiantToadTaskComponent/GiantToadTaskComponent.md)</span><span class="signature">({<span id="param-task" class="parameter">required <span class="type-annotation">[GiantToadTask](../giant_toad/GiantToadTask-class.md)<span class="signature">\<<span class="type-parameter">C</span>\></span></span> <span class="parameter-name">task</span>, </span><span id="param-context" class="parameter">required <span class="type-annotation">C</span> <span class="parameter-name">context</span></span>})</span>  
...
<span class="name">[context](../giant_toad/GiantToadTaskComponent/context.md)</span> <span class="signature">→ C</span>  
<div>
...
<span class="name">[status](../giant_toad/GiantToadTaskComponent/status.md)</span> <span class="signature">↔ [GiantToadTaskStatus](../giant_toad/GiantToadTaskStatus.md)</span>  
<div>
...
<span class="name">[task](../giant_toad/GiantToadTaskComponent/task.md)</span> <span class="signature">→ [GiantToadTask](../giant_toad/GiantToadTask-class.md)<span class="signature">\<<span class="type-parameter">C</span>\></span></span>  
<div>
...
<span class="name">[cancel](../giant_toad/GiantToadTaskComponent/cancel.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[restart](../giant_toad/GiantToadTaskComponent/restart.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[update](../giant_toad/GiantToadTaskComponent/update.md)</span><span class="signature">(<span id="update-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
3.  GiantToadTaskComponent<span class="signature">\<<span class="type-parameter">C</span>\></span> class
