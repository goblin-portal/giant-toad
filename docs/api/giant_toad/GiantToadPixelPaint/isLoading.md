...
# <span class="kind-property">isLoading</span> property
...
<span class="returntype">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> get <span class="name">isLoading</span>
