...
# <span class="kind-class">GiantToadCapabilityStatus</span> class
...
<span class="name">[GiantToadCapabilityStatus.supported](../src_runtime_giant_toad_capabilities/GiantToadCapabilityStatus/GiantToadCapabilityStatus.supported.md)</span><span class="signature">()</span>  
<div>
...
<span class="name">[GiantToadCapabilityStatus.unsupported](../src_runtime_giant_toad_capabilities/GiantToadCapabilityStatus/GiantToadCapabilityStatus.unsupported.md)</span><span class="signature">(<span id="unsupported-param-reason" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span> <span class="parameter-name">reason</span></span>)</span>  
<div>
...
<span class="name">[reason](../src_runtime_giant_toad_capabilities/GiantToadCapabilityStatus/reason.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span>  
<div>
...
<span class="name">[supported](../src_runtime_giant_toad_capabilities/GiantToadCapabilityStatus/supported.md)</span> <span class="signature">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
<div>
...
3.  GiantToadCapabilityStatus class
