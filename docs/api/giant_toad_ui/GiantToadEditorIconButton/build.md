...
If a widget's [build](../../giant_toad_ui/GiantToadEditorIconButton/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadEditorIconButton](../../giant_toad_ui/GiantToadEditorIconButton-class.md)
4.  build method

##### GiantToadEditorIconButton class
