...
<span class="returntype">[Future](https://api.flutter.dev/flutter/dart-async/Future-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadSaveData](../../giant_toad/GiantToadSaveData-class.md)?</span>\></span></span> <span class="name">load</span>(
