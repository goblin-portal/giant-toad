...
<span class="returntype">dynamic</span> <span class="name">create</span>({

1.  <span id="create-param-size" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">size</span>, </span>
...
5.  <span id="create-param-color" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">color</span> = <span class="default-value">const Color(0xffff5c14)</span>, </span>
