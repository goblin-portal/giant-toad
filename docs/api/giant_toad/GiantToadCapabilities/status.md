...
<span class="returntype">[GiantToadCapabilityStatus](../../giant_toad/GiantToadCapabilityStatus-class.md)</span> <span class="name">status</span>(

1.  <span id="status-param-capability" class="parameter"><span class="type-annotation">[GiantToadCapability](../../giant_toad/GiantToadCapability.md)</span> <span class="parameter-name">capability</span></span>
