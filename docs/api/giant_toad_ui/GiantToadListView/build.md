...
If a widget's [build](../../giant_toad_ui/GiantToadListView/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadListView<span class="signature">\<<span class="type-parameter">T</span>\></span>](../../giant_toad_ui/GiantToadListView-class.md)
4.  build method
