...
# <span class="kind-class">GiantToadSceneRoute</span> class
...
- [Route](https://pub.dev/documentation/flame/1.38.0/game/Route-class.md)
- GiantToadSceneRoute
...
<span class="name">[GiantToadSceneRoute](../giant_toad/GiantToadSceneRoute/GiantToadSceneRoute.md)</span><span class="signature">({<span id="param-builder" class="parameter">required <span class="type-annotation">[Component](https://pub.dev/documentation/flame/1.38.0/components/Component-class.md)</span> <span class="parameter-name">builder</span>(), </span><span id="param-onActivated" class="parameter"><span class="type-annotation">void</span> <span class="parameter-name">onActivated</span>(<span id="param-previous" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span> <span class="parameter-name">previous</span></span>)?, </span><span id="param-onDeactivated" class="parameter"><span class="type-annotation">void</span> <span class="parameter-name">onDeactivated</span>(<span id="param-next" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">next</span></span>)?, </span><span id="param-transparent" class="parameter"><span class="type-annotation">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> <span class="parameter-name">transparent</span> = <span class="default-value">false</span>, </span><span id="param-maintainState" class="parameter"><span class="type-annotation">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> <span class="parameter-name">maintainState</span> = <span class="default-value">true</span></span>})</span>  
...
<span class="name">[maintainState](https://pub.dev/documentation/flame/1.38.0/game/Route/maintainState.md)</span> <span class="signature">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
If false, the route will not maintain the state of this route's page component. By default, once a route becomes active, the component built by the build routine is maintained by the route after the route is popped off the stack. Setting [maintainState](https://pub.dev/documentation/flame/1.38.0/game/Route/maintainState.md) to false will drop the page component when the route is popped off the stack.
...
<span class="name">[name](https://pub.dev/documentation/flame/1.38.0/game/Route/name.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span>  
The name of the route (set by the [RouterComponent](https://pub.dev/documentation/flame/1.38.0/game/RouterComponent-class.md)).
...
<span class="name">[onActivated](../giant_toad/GiantToadSceneRoute/onActivated.md)</span> <span class="signature">→ void Function<span class="signature">(<span id="param-previous" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span> <span class="parameter-name">previous</span></span>)</span>?</span>  
<div>
...
<span class="name">[onDeactivated](../giant_toad/GiantToadSceneRoute/onDeactivated.md)</span> <span class="signature">→ void Function<span class="signature">(<span id="param-next" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">next</span></span>)</span>?</span>  
<div>
...
<span class="name">[parent](https://pub.dev/documentation/flame/1.38.0/components/ParentIsA/parent.md)</span> <span class="signature">↔ [RouterComponent](https://pub.dev/documentation/flame/1.38.0/game/RouterComponent-class.md)</span>  
...
<span class="name">[resources](../giant_toad/GiantToadSceneRoute/resources.md)</span> <span class="signature">→ [GiantToadSceneResources](../giant_toad/GiantToadSceneResources-class.md)</span>  
<div>
...
<span class="name">[timeScale](https://pub.dev/documentation/flame/1.38.0/components/HasTimeScale/timeScale.md)</span> <span class="signature">↔ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
...
<span class="name">[transparent](https://pub.dev/documentation/flame/1.38.0/game/Route/transparent.md)</span> <span class="signature">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
...
<span class="name">[addRenderEffect](https://pub.dev/documentation/flame/1.38.0/game/Route/addRenderEffect.md)</span><span class="signature">(<span id="addRenderEffect-param-effect" class="parameter"><span class="type-annotation">[Decorator](https://pub.dev/documentation/flame/1.38.0/rendering/Decorator-class.md)</span> <span class="parameter-name">effect</span></span>) <span class="returntype parameter">→ void</span> </span>  
Applies the provided [Decorator](https://pub.dev/documentation/flame/1.38.0/rendering/Decorator-class.md) to the page.
...
<span class="name">[build](https://pub.dev/documentation/flame/1.38.0/game/Route/build.md)</span><span class="signature">() <span class="returntype parameter">→ [Component](https://pub.dev/documentation/flame/1.38.0/components/Component-class.md)</span> </span>  
...
<span class="name">[onMount](https://pub.dev/documentation/flame/1.38.0/components/ParentIsA/onMount.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[onPop](../giant_toad/GiantToadSceneRoute/onPop.md)</span><span class="signature">(<span id="onPop-param-nextRoute" class="parameter"><span class="type-annotation">[Route](https://pub.dev/documentation/flame/1.38.0/game/Route-class.md)</span> <span class="parameter-name">nextRoute</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[onPush](../giant_toad/GiantToadSceneRoute/onPush.md)</span><span class="signature">(<span id="onPush-param-previousRoute" class="parameter"><span class="type-annotation">[Route](https://pub.dev/documentation/flame/1.38.0/game/Route-class.md)?</span> <span class="parameter-name">previousRoute</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[onRemove](../giant_toad/GiantToadSceneRoute/onRemove.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[pause](https://pub.dev/documentation/flame/1.38.0/components/HasTimeScale/pause.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[removeRenderEffect](https://pub.dev/documentation/flame/1.38.0/game/Route/removeRenderEffect.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
Removes current [Decorator](https://pub.dev/documentation/flame/1.38.0/rendering/Decorator-class.md), is any.
...
<span class="name">[renderTree](https://pub.dev/documentation/flame/1.38.0/game/Route/renderTree.md)</span><span class="signature">(<span id="renderTree-param-canvas" class="parameter"><span class="type-annotation">[Canvas](https://api.flutter.dev/flutter/dart-ui/Canvas-class.md)</span> <span class="parameter-name">canvas</span></span>) <span class="returntype parameter">→ void</span> </span>  
<div>
...
<span class="name">[resume](https://pub.dev/documentation/flame/1.38.0/components/HasTimeScale/resume.md)</span><span class="signature">({<span id="resume-param-newTimeScale" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)?</span> <span class="parameter-name">newTimeScale</span></span>}) <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[resumeTime](https://pub.dev/documentation/flame/1.38.0/game/Route/resumeTime.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[stopTime](https://pub.dev/documentation/flame/1.38.0/game/Route/stopTime.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[update](https://pub.dev/documentation/flame/1.38.0/components/HasTimeScale/update.md)</span><span class="signature">(<span id="update-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[updateTree](https://pub.dev/documentation/flame/1.38.0/game/Route/updateTree.md)</span><span class="signature">(<span id="updateTree-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
This method traverses the component tree and calls [update](https://pub.dev/documentation/flame/1.38.0/components/HasTimeScale/update.md) on all its children according to their [priority](https://pub.dev/documentation/flame/1.38.0/components/Component/priority.md) order, relative to the priority of the direct siblings, not the children or the ancestors.
