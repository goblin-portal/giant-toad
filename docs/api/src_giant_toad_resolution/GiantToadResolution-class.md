...
# <span class="kind-class">GiantToadResolution</span> class
...
Giant Toad preserves [width](../src_giant_toad_resolution/GiantToadResolution/width.md) by default and expands the visible logical height to match the available display. Use a fixed viewport explicitly when a game requires a locked aspect ratio.
...
<span class="name">[GiantToadResolution](../src_giant_toad_resolution/GiantToadResolution/GiantToadResolution.md)</span><span class="signature">({<span id="param-width" class="parameter">required <span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">width</span>, </span><span id="param-height" class="parameter">required <span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">height</span></span>})</span>  
...
<span class="name">[height](../src_giant_toad_resolution/GiantToadResolution/height.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
...
<span class="name">[width](../src_giant_toad_resolution/GiantToadResolution/width.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
...
2.  [giant_toad_resolution](../src_giant_toad_resolution/index.md)
3.  GiantToadResolution class

##### giant_toad_resolution library
