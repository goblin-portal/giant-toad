...
# <span class="kind-class">GiantToadKeyboardActions</span> class
...
- GiantToadKeyboardActions

Mixed-in types  
- [KeyboardHandler](https://pub.dev/documentation/flame/1.38.0/components/KeyboardHandler-mixin.md)
...
<span class="name">[GiantToadKeyboardActions](../giant_toad/GiantToadKeyboardActions/GiantToadKeyboardActions.md)</span><span class="signature">(<span id="param-input" class="parameter"><span class="type-annotation">[GiantToadActionInput](../giant_toad/GiantToadActionInput-class.md)</span> <span class="parameter-name">input</span></span>)</span>  
...
<span class="name">[input](../giant_toad/GiantToadKeyboardActions/input.md)</span> <span class="signature">→ [GiantToadActionInput](../giant_toad/GiantToadActionInput-class.md)</span>  
<div>
...
<span class="name">[onKeyEvent](../giant_toad/GiantToadKeyboardActions/onKeyEvent.md)</span><span class="signature">(<span id="onKeyEvent-param-event" class="parameter"><span class="type-annotation">[KeyEvent](https://api.flutter.dev/flutter/services/KeyEvent-class.md)</span> <span class="parameter-name">event</span>, </span><span id="onKeyEvent-param-keysPressed" class="parameter"><span class="type-annotation">[Set](https://api.flutter.dev/flutter/dart-core/Set-class.md)<span class="signature">\<<span class="type-parameter">[LogicalKeyboardKey](https://api.flutter.dev/flutter/services/LogicalKeyboardKey-class.md)</span>\></span></span> <span class="parameter-name">keysPressed</span></span>) <span class="returntype parameter">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> </span>  
<div>
...
<span class="name">[onRemove](../giant_toad/GiantToadKeyboardActions/onRemove.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
3.  GiantToadKeyboardActions class
