...
1.  <span id="param-store" class="parameter">required <span class="type-annotation">[GiantToadStore](../../src_runtime_giant_toad_systems/GiantToadStore-class.md)</span> <span class="parameter-name">store</span>, </span>
...
3.  <span id="param-migrations" class="parameter"><span class="type-annotation">[Map](https://api.flutter.dev/flutter/dart-core/Map-class.md)<span class="signature">\<<span class="type-parameter">[int](https://api.flutter.dev/flutter/dart-core/int-class.md)</span>, <span class="type-parameter">[GiantToadSaveMigration](../../src_runtime_giant_toad_persistence/GiantToadSaveMigration.md)</span>\></span></span> <span class="parameter-name">migrations</span> = <span class="default-value">const {}</span>, </span>
