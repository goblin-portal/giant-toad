...
<span class="returntype">[Future](https://api.flutter.dev/flutter/dart-async/Future-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadLavaSurfaceShader](../../src_render_giant_toad_surface_shaders/GiantToadLavaSurfaceShader-class.md)</span>\></span></span> <span class="name">load</span>()
