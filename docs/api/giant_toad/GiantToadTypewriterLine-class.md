...
# <span class="kind-class">GiantToadTypewriterLine</span> class
...
<span class="name">[GiantToadTypewriterLine](../giant_toad/GiantToadTypewriterLine/GiantToadTypewriterLine.md)</span><span class="signature">({<span id="param-text" class="parameter">required <span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">text</span>, </span><span id="param-speaker" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span> <span class="parameter-name">speaker</span></span>})</span>  
<div>
...
<span class="name">[speaker](../giant_toad/GiantToadTypewriterLine/speaker.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span>  
<div>
...
<span class="name">[text](../giant_toad/GiantToadTypewriterLine/text.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>  
<div>
...
3.  GiantToadTypewriterLine class
