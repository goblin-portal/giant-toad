...
4.  <span id="param-velocity" class="parameter"><span class="type-annotation">[Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)?</span> <span class="parameter-name">velocity</span>, </span>
5.  <span id="param-textRenderer" class="parameter"><span class="type-annotation">[TextRenderer](https://pub.dev/documentation/flame/1.38.0/text/TextRenderer-class.md)?</span> <span class="parameter-name">textRenderer</span>, </span>
