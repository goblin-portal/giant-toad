...
1.  <span id="param-changes" class="parameter"><span class="type-annotation">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadMapCellChange](../../giant_toad/GiantToadMapCellChange-class.md)</span>\></span></span> <span class="parameter-name">changes</span></span>
