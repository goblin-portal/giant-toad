...
<span class="name">[decode](../src_input_giant_toad_actions/GiantToadActionMapCodec/decode.md)</span><span class="signature">(<span id="decode-param-source" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">source</span></span>) <span class="returntype parameter">→ [GiantToadActionMap](../src_input_giant_toad_actions/GiantToadActionMap-class.md)</span> </span>  

<span class="name">[encode](../src_input_giant_toad_actions/GiantToadActionMapCodec/encode.md)</span><span class="signature">(<span id="encode-param-bindings" class="parameter"><span class="type-annotation">[GiantToadActionMap](../src_input_giant_toad_actions/GiantToadActionMap-class.md)</span> <span class="parameter-name">bindings</span></span>) <span class="returntype parameter">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> </span>  
...
3.  GiantToadActionMapCodec class
