...
If a subclass overrides the equality operator, it should override the [hashCode](../../src_input_giant_toad_actions/GiantToadAction/hashCode.md) method as well to maintain consistency.
