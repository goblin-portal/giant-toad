...
1.  <span id="call-param-canvas" class="parameter"><span class="type-annotation">[Canvas](https://api.flutter.dev/flutter/dart-ui/Canvas-class.md)</span> <span class="parameter-name">canvas</span>, </span>
2.  <span id="call-param-rawCell" class="parameter"><span class="type-annotation">[GiantToadMapCell](../../giant_toad/GiantToadMapCell.md)?</span> <span class="parameter-name">rawCell</span>, </span>
