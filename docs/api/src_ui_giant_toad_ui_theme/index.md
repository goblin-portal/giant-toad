...
# <span class="kind-library">src/ui/giant_toad_ui_theme</span> library
...
<span class="name">[GiantToadPixelPanel](../src_ui_giant_toad_ui_theme/GiantToadPixelPanel-class.md)</span>  
A pixel-styled panel for use in a Flutter game overlay.

<span class="name">[GiantToadUiTheme](../src_ui_giant_toad_ui_theme/GiantToadUiTheme-class.md)</span>  
Shared visual tokens for Giant Toad pixel-game overlays.

<span class="name">[GiantToadUiThemeScope](../src_ui_giant_toad_ui_theme/GiantToadUiThemeScope-class.md)</span>  
...
<span class="name">[giantToadMaterialTheme](../src_ui_giant_toad_ui_theme/giantToadMaterialTheme.md)</span><span class="signature">(<span id="giantToadMaterialTheme-param-theme" class="parameter"><span class="type-annotation">[GiantToadUiTheme](../src_ui_giant_toad_ui_theme/GiantToadUiTheme-class.md)</span> <span class="parameter-name">theme</span>, {</span><span id="giantToadMaterialTheme-param-backgroundColor" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">backgroundColor</span> = <span class="default-value">const Color(0xff11111b)</span>, </span><span id="giantToadMaterialTheme-param-errorColor" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">errorColor</span></span>}) <span class="returntype parameter">→ dynamic</span> </span>  
...
2.  src/ui/giant_toad_ui_theme.dart
