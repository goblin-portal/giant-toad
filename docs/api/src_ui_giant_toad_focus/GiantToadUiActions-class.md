...
<span class="name">[activate](../src_ui_giant_toad_focus/GiantToadUiActions/activate-constant.md)</span> <span class="signature">→ const [GiantToadAction](../src_input_giant_toad_actions/GiantToadAction-class.md)</span>  

<span class="name">[next](../src_ui_giant_toad_focus/GiantToadUiActions/next-constant.md)</span> <span class="signature">→ const [GiantToadAction](../src_input_giant_toad_actions/GiantToadAction-class.md)</span>  

<span class="name">[previous](../src_ui_giant_toad_focus/GiantToadUiActions/previous-constant.md)</span> <span class="signature">→ const [GiantToadAction](../src_input_giant_toad_actions/GiantToadAction-class.md)</span>  
