...
1.  <span id="param-nodes" class="parameter">required <span class="type-annotation">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadDialogueNode](../../src_gameplay_giant_toad_dialogue/GiantToadDialogueNode-class.md)</span>\></span></span> <span class="parameter-name">nodes</span>, </span>
