...
# <span class="kind-library">src/ui/giant_toad_ui_feedback</span> library
...
<span class="name">[GiantToadUiFeedback](../src_ui_giant_toad_ui_feedback/GiantToadUiFeedback-class.md)</span>  
...
2.  src/ui/giant_toad_ui_feedback.dart
...
##### giant_toad_ui_feedback library
