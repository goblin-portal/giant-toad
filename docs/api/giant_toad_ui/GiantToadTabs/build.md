...
If a widget's [build](../../giant_toad_ui/GiantToadTabs/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadTabs](../../giant_toad_ui/GiantToadTabs-class.md)
4.  build method
