...
If a widget's [build](../../giant_toad_ui/GiantToadProgressBar/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadProgressBar](../../giant_toad_ui/GiantToadProgressBar-class.md)
4.  build method

##### GiantToadProgressBar class
