...
<span class="returntype">[Set](https://api.flutter.dev/flutter/dart-core/Set-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadEditedChunk](../../src_tilemap_giant_toad_map_edit/GiantToadEditedChunk.md)</span>\></span></span> <span class="name">affectedChunks</span>(
