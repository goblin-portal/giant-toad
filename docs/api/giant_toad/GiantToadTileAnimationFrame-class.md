...
# <span class="kind-class">GiantToadTileAnimationFrame</span> class
...
<span class="name">[GiantToadTileAnimationFrame](../giant_toad/GiantToadTileAnimationFrame/GiantToadTileAnimationFrame.md)</span><span class="signature">({<span id="param-tileId" class="parameter">required <span class="type-annotation">[int](https://api.flutter.dev/flutter/dart-core/int-class.md)</span> <span class="parameter-name">tileId</span>, </span><span id="param-duration" class="parameter">required <span class="type-annotation">[Duration](https://api.flutter.dev/flutter/dart-core/Duration-class.md)</span> <span class="parameter-name">duration</span></span>})</span>  
<div>
...
<span class="name">[duration](../giant_toad/GiantToadTileAnimationFrame/duration.md)</span> <span class="signature">→ [Duration](https://api.flutter.dev/flutter/dart-core/Duration-class.md)</span>  
<div>
...
<span class="name">[tileId](../giant_toad/GiantToadTileAnimationFrame/tileId.md)</span> <span class="signature">→ [int](https://api.flutter.dev/flutter/dart-core/int-class.md)</span>  
<div>
...
3.  GiantToadTileAnimationFrame class
