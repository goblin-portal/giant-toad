...
<span class="name">[GiantToadCard](../src_ui_giant_toad_editor_controls/GiantToadCard/GiantToadCard.md)</span><span class="signature">({<span id="param-child" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">child</span>, </span><span id="param-margin" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">margin</span>, </span><span id="param-key" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">key</span></span>})</span>  
<div>
...
<span class="name">[child](../src_ui_giant_toad_editor_controls/GiantToadCard/child.md)</span> <span class="signature">→ dynamic</span>  
<div>
...
<span class="name">[margin](../src_ui_giant_toad_editor_controls/GiantToadCard/margin.md)</span> <span class="signature">→ dynamic</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_editor_controls/GiantToadCard/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
