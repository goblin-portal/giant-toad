...
<span class="returntype">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadAction](../../src_input_giant_toad_actions/GiantToadAction-class.md)</span>\></span></span> <span class="name">actionsFor</span>(
