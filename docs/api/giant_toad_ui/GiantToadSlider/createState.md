...
<span class="returntype">[State](https://api.flutter.dev/flutter/widgets/State-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadSlider](../../giant_toad_ui/GiantToadSlider-class.md)</span>\></span></span> <span class="name">createState</span>()
