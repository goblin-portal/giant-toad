...
1.  <span id="createAll-param-objects" class="parameter"><span class="type-annotation">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadMapObject](../../src_tilemap_giant_toad_map_runtime/GiantToadMapObject-class.md)</span>\></span></span> <span class="parameter-name">objects</span></span>
