...
If a widget's [build](../../giant_toad_ui/GiantToadExpansionPanel/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
