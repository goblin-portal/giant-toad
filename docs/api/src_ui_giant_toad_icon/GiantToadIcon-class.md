...
<span class="name">[GiantToadIcon](../src_ui_giant_toad_icon/GiantToadIcon/GiantToadIcon.md)</span><span class="signature">(<span id="param-icon" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">icon</span>, {</span><span id="param-key" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">key</span>, </span><span id="param-size" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)?</span> <span class="parameter-name">size</span></span>})</span>  
<div>
...
<span class="name">[icon](../src_ui_giant_toad_icon/GiantToadIcon/icon.md)</span> <span class="signature">→ dynamic</span>  
<div>
...
<span class="name">[size](../src_ui_giant_toad_icon/GiantToadIcon/size.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)?</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_icon/GiantToadIcon/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
