...
# <span class="kind-library">src/ui/giant_toad_focus</span> library
...
<span class="name">[GiantToadFocusActions](../src_ui_giant_toad_focus/GiantToadFocusActions-class.md)</span>  
Routes semantic Giant Toad actions into Flutter focus traversal.

<span class="name">[GiantToadFocusScope](../src_ui_giant_toad_focus/GiantToadFocusScope-class.md)</span>  
Pixel UI focus scope with keyboard/gamepad-style directional navigation.

<span class="name">[GiantToadUiActions](../src_ui_giant_toad_focus/GiantToadUiActions-class.md)</span>  
...
2.  src/ui/giant_toad_focus.dart
