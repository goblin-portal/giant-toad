...
<span class="name">[GiantToadWorldHit](../giant_toad/GiantToadWorldHit/GiantToadWorldHit.md)</span><span class="signature">({<span id="param-collider" class="parameter">required <span class="type-annotation">[GiantToadWorldCollider](../giant_toad/GiantToadWorldCollider-class.md)</span> <span class="parameter-name">collider</span>, </span><span id="param-normal" class="parameter">required <span class="type-annotation">[Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)</span> <span class="parameter-name">normal</span></span>})</span>  
<div>
...
<span class="name">[collider](../giant_toad/GiantToadWorldHit/collider.md)</span> <span class="signature">→ [GiantToadWorldCollider](../giant_toad/GiantToadWorldCollider-class.md)</span>  
<div>
...
<span class="name">[normal](../giant_toad/GiantToadWorldHit/normal.md)</span> <span class="signature">→ [Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)</span>  
<div>
