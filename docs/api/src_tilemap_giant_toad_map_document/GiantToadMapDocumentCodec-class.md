...
<span class="name">[decode](../src_tilemap_giant_toad_map_document/GiantToadMapDocumentCodec/decode.md)</span><span class="signature">(<span id="decode-param-source" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">source</span></span>) <span class="returntype parameter">→ [GiantToadMapDocument](../src_tilemap_giant_toad_map_document/GiantToadMapDocument-class.md)</span> </span>  

<span class="name">[encode](../src_tilemap_giant_toad_map_document/GiantToadMapDocumentCodec/encode.md)</span><span class="signature">(<span id="encode-param-document" class="parameter"><span class="type-annotation">[GiantToadMapDocument](../src_tilemap_giant_toad_map_document/GiantToadMapDocument-class.md)</span> <span class="parameter-name">document</span></span>) <span class="returntype parameter">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> </span>  
...
3.  GiantToadMapDocumentCodec class
