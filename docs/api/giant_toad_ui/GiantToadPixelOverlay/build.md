...
If a widget's [build](../../giant_toad_ui/GiantToadPixelOverlay/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadPixelOverlay](../../giant_toad_ui/GiantToadPixelOverlay-class.md)
4.  build method

##### GiantToadPixelOverlay class
