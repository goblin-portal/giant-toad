...
If a widget's [build](../../giant_toad_ui/GiantToadPopupMenuButton/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadPopupMenuButton<span class="signature">\<<span class="type-parameter">T</span>\></span>](../../giant_toad_ui/GiantToadPopupMenuButton-class.md)
4.  build method

##### GiantToadPopupMenuButton class
