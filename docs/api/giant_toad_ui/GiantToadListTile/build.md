...
If a widget's [build](../../giant_toad_ui/GiantToadListTile/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadListTile](../../giant_toad_ui/GiantToadListTile-class.md)
4.  build method
