...
# <span class="kind-class">GiantToadPixelAnimationComponent</span> class
...
- [SpriteAnimationComponent](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent-class.md)
- GiantToadPixelAnimationComponent

Mixed-in types  
- [GiantToadPixelPaint](../giant_toad/GiantToadPixelPaint-mixin.md)
...
<span class="name">[GiantToadPixelAnimationComponent](../giant_toad/GiantToadPixelAnimationComponent/GiantToadPixelAnimationComponent.md)</span><span class="signature">({<span id="param-animation" class="parameter"><span class="type-annotation">[SpriteAnimation](https://pub.dev/documentation/flame/1.38.0/sprite/SpriteAnimation-class.md)?</span> <span class="parameter-name">animation</span>, </span><span id="param-position" class="parameter"><span class="type-annotation">[Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)?</span> <span class="parameter-name">position</span>, </span><span id="param-size" class="parameter"><span class="type-annotation">[Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)?</span> <span class="parameter-name">size</span>, </span><span id="param-anchor" class="parameter"><span class="type-annotation">[Anchor](https://pub.dev/documentation/flame/1.38.0/components/Anchor-class.md)?</span> <span class="parameter-name">anchor</span>, </span><span id="param-angle" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)?</span> <span class="parameter-name">angle</span>, </span><span id="param-priority" class="parameter"><span class="type-annotation">[int](https://api.flutter.dev/flutter/dart-core/int-class.md)?</span> <span class="parameter-name">priority</span>, </span><span id="param-key" class="parameter"><span class="type-annotation">[ComponentKey](https://pub.dev/documentation/flame/1.38.0/components/ComponentKey-class.md)?</span> <span class="parameter-name">key</span>, </span><span id="param-sampling" class="parameter"><span class="type-annotation">[GiantToadSampling](../giant_toad/GiantToadSampling.md)</span> <span class="parameter-name">sampling</span> = <span class="default-value">GiantToadSampling.pixelPerfect</span></span>})</span>  
...
<span class="name">[animation](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/animation.md)</span> <span class="signature">↔ [SpriteAnimation](https://pub.dev/documentation/flame/1.38.0/sprite/SpriteAnimation-class.md)?</span>  
Returns the current [SpriteAnimation](https://pub.dev/documentation/flame/1.38.0/sprite/SpriteAnimation-class.md).
...
<span class="name">[animationTicker](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/animationTicker.md)</span> <span class="signature">→ [SpriteAnimationTicker](https://pub.dev/documentation/flame/1.38.0/sprite/SpriteAnimationTicker-class.md)?</span>  
Returns the animation ticker for current [animation](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/animation.md).
...
<span class="name">[autoResize](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/autoResize.md)</span> <span class="signature">↔ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
...
<span class="name">[playing](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/playing.md)</span> <span class="signature">↔ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
...
<span class="name">[removeOnFinish](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/removeOnFinish.md)</span> <span class="signature">↔ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
...
<span class="name">[resetOnRemove](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/resetOnRemove.md)</span> <span class="signature">↔ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
Whether to reset the animation when the component is removed from the component tree.
...
<span class="name">[sampling](../giant_toad/GiantToadPixelAnimationComponent/sampling.md)</span> <span class="signature">→ [GiantToadSampling](../giant_toad/GiantToadSampling.md)</span>  
<div>
...
<span class="name">[onRemove](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/onRemove.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[update](https://pub.dev/documentation/flame/1.38.0/components/SpriteAnimationComponent/update.md)</span><span class="signature">(<span id="update-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
3.  GiantToadPixelAnimationComponent class
