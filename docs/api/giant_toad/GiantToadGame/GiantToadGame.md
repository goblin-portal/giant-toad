...
# <span class="kind-constructor">GiantToadGame\<<span class="type-parameter">W extends World</span>\></span> constructor

</div>

<div>

<span class="name">GiantToadGame\<<span class="type-parameter">W extends World</span>\></span>({
...
2.  <span id="param-resolution" class="parameter"><span class="type-annotation">[GiantToadResolution](../../giant_toad/GiantToadResolution-class.md)?</span> <span class="parameter-name">resolution</span>, </span>
3.  <span id="param-viewportMode" class="parameter"><span class="type-annotation">[GiantToadViewportMode](../../giant_toad/GiantToadViewportMode.md)</span> <span class="parameter-name">viewportMode</span> = <span class="default-value">GiantToadViewportMode.expand</span>, </span>
