...
# <span class="kind-library">src/ui/giant_toad_overlay</span> library
...
<span class="name">[GiantToadDisplayUiOverlay](../src_ui_giant_toad_overlay/GiantToadDisplayUiOverlay-class.md)</span>  
...
<span class="name">[GiantToadNativeText](../src_ui_giant_toad_overlay/GiantToadNativeText-class.md)</span>  
Text description in authored game coordinates.

<span class="name">[GiantToadNativeTextOverlay](../src_ui_giant_toad_overlay/GiantToadNativeTextOverlay-class.md)</span>  
Positions text on the game grid but rasterizes glyphs at display resolution.

<span class="name">[GiantToadOverlay](../src_ui_giant_toad_overlay/GiantToadOverlay-class.md)</span>  
Placement primitive for callers that already have viewport metrics.

<span class="name">[GiantToadPixelOverlay](../src_ui_giant_toad_overlay/GiantToadPixelOverlay-class.md)</span>  
...
<span class="name">[GiantToadDisplayUiBuilder](../src_ui_giant_toad_overlay/GiantToadDisplayUiBuilder.md)</span><span class="signature"> <span class="returntype parameter">= dynamic Function<span class="signature">(<span id="param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span>, </span><span id="param-scale" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">scale</span>, </span><span id="param-logicalSize" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">logicalSize</span></span>)</span></span> </span>  
...
2.  src/ui/giant_toad_overlay.dart
