...
<span class="returntype">[List](https://api.flutter.dev/flutter/dart-core/List-class.md)</span> <span class="name">cellCenters</span>(

1.  <span id="cellCenters-param-cells" class="parameter"><span class="type-annotation">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadCell](../../src_gameplay_giant_toad_pathfinding/GiantToadCell-class.md)</span>\></span></span> <span class="parameter-name">cells</span>, {</span>
