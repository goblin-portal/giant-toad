...
# <span class="kind-class">GiantToadValueChoice\<<span class="type-parameter">T</span>\></span> class
...
<span class="name">[GiantToadValueChoice](../src_gameplay_giant_toad_dialogue/GiantToadValueChoice/GiantToadValueChoice.md)</span><span class="signature">({<span id="param-text" class="parameter">required <span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">text</span>, </span><span id="param-value" class="parameter">required <span class="type-annotation">T</span> <span class="parameter-name">value</span></span>})</span>  
<div>
...
<span class="name">[text](../src_gameplay_giant_toad_dialogue/GiantToadValueChoice/text.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>  
<div>
...
<span class="name">[value](../src_gameplay_giant_toad_dialogue/GiantToadValueChoice/value.md)</span> <span class="signature">→ T</span>  
<div>
...
3.  GiantToadValueChoice<span class="signature">\<<span class="type-parameter">T</span>\></span> class
