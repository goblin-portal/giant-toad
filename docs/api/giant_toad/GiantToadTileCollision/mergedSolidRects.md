...
<span class="returntype">[List](https://api.flutter.dev/flutter/dart-core/List-class.md)<span class="signature">\<<span class="type-parameter">[Rect](https://api.flutter.dev/flutter/dart-ui/Rect-class.md)</span>\></span></span> <span class="name">mergedSolidRects</span>({
