...
If a widget's [build](../../giant_toad_ui/GiantToadHotbar/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadHotbar](../../giant_toad_ui/GiantToadHotbar-class.md)
4.  build method

##### GiantToadHotbar class
