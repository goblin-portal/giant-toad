...
<span class="returntype">[Future](https://api.flutter.dev/flutter/dart-async/Future-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadPreferencesStore](../../giant_toad/GiantToadPreferencesStore-class.md)</span>\></span></span> <span class="name">create</span>({
