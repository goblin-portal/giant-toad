...
If a subclass overrides the equality operator, it should override the [hashCode](../../src_gameplay_giant_toad_pathfinding/GiantToadCell/hashCode.md) method as well to maintain consistency.
