...
<span class="name">[GiantToadTooltip](../src_ui_giant_toad_game_widgets/GiantToadTooltip/GiantToadTooltip.md)</span><span class="signature">({<span id="param-message" class="parameter">required <span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">message</span>, </span><span id="param-key" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">key</span></span>})</span>  
<div>
...
<span class="name">[message](../src_ui_giant_toad_game_widgets/GiantToadTooltip/message.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_game_widgets/GiantToadTooltip/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
