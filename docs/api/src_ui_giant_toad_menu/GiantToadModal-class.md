...
<span class="name">[child](../src_ui_giant_toad_menu/GiantToadModal/child.md)</span> <span class="signature">→ dynamic</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_menu/GiantToadModal/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
