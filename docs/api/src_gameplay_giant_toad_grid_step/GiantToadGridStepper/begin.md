...
1.  <span id="begin-param-body" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">body</span>, </span>
2.  <span id="begin-param-direction" class="parameter">required <span class="type-annotation">[GiantToadGridDirection](../../src_gameplay_giant_toad_grid_step/GiantToadGridDirection.md)</span> <span class="parameter-name">direction</span>, </span>
3.  <span id="begin-param-isBlocked" class="parameter">required <span class="type-annotation">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> <span class="parameter-name">isBlocked</span>(</span>
    1.  <span id="param-destination" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">destination</span></span>
