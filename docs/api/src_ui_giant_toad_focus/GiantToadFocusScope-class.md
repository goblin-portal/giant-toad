...
# <span class="kind-class">GiantToadFocusScope</span> class
...
<span class="name">[GiantToadFocusScope](../src_ui_giant_toad_focus/GiantToadFocusScope/GiantToadFocusScope.md)</span><span class="signature">({<span id="param-child" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">child</span>, </span><span id="param-key" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">key</span></span>})</span>  
<div>
...
<span class="name">[child](../src_ui_giant_toad_focus/GiantToadFocusScope/child.md)</span> <span class="signature">→ dynamic</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_focus/GiantToadFocusScope/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
...
3.  GiantToadFocusScope class

##### giant_toad_focus library
