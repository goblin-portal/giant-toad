...
1.  <span id="param-frames" class="parameter"><span class="type-annotation">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadTileAnimationFrame](../../src_tilemap_giant_toad_map_runtime/GiantToadTileAnimationFrame-class.md)</span>\></span></span> <span class="parameter-name">frames</span></span>
