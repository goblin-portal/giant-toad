...
<span class="name">[decode](../giant_toad/GiantToadAreaDocumentCodec/decode.md)</span><span class="signature">(<span id="decode-param-source" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">source</span></span>) <span class="returntype parameter">→ [GiantToadAreaDocument](../giant_toad/GiantToadAreaDocument-class.md)</span> </span>  

<span class="name">[encode](../giant_toad/GiantToadAreaDocumentCodec/encode.md)</span><span class="signature">(<span id="encode-param-document" class="parameter"><span class="type-annotation">[GiantToadAreaDocument](../giant_toad/GiantToadAreaDocument-class.md)</span> <span class="parameter-name">document</span></span>) <span class="returntype parameter">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> </span>  
...
3.  GiantToadAreaDocumentCodec class
