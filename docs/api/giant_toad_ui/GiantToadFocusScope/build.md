...
If a widget's [build](../../giant_toad_ui/GiantToadFocusScope/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadFocusScope](../../giant_toad_ui/GiantToadFocusScope-class.md)
4.  build method
