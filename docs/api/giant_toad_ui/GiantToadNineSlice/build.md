...
If a widget's [build](../../giant_toad_ui/GiantToadNineSlice/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadNineSlice](../../giant_toad_ui/GiantToadNineSlice-class.md)
4.  build method

##### GiantToadNineSlice class
