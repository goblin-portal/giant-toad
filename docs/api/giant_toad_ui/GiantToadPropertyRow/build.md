...
If a widget's [build](../../giant_toad_ui/GiantToadPropertyRow/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadPropertyRow](../../giant_toad_ui/GiantToadPropertyRow-class.md)
4.  build method
