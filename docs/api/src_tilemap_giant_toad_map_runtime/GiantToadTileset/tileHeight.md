...
# <span class="kind-property">tileHeight</span> property

</div>

<div>

[int](https://api.flutter.dev/flutter/dart-core/int-class.md) <span class="name">tileHeight</span>
