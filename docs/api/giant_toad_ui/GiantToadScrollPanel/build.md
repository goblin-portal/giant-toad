...
If a widget's [build](../../giant_toad_ui/GiantToadScrollPanel/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadScrollPanel](../../giant_toad_ui/GiantToadScrollPanel-class.md)
4.  build method

##### GiantToadScrollPanel class
