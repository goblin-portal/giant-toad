...
<span class="name">[GiantToadHotbar](../src_ui_giant_toad_game_widgets/GiantToadHotbar/GiantToadHotbar.md)</span><span class="signature">({<span id="param-slots" class="parameter">required <span class="type-annotation">[List](https://api.flutter.dev/flutter/dart-core/List-class.md)</span> <span class="parameter-name">slots</span>, </span><span id="param-key" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">key</span></span>})</span>  
<div>
...
<span class="name">[slots](../src_ui_giant_toad_game_widgets/GiantToadHotbar/slots.md)</span> <span class="signature">→ [List](https://api.flutter.dev/flutter/dart-core/List-class.md)</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_game_widgets/GiantToadHotbar/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
