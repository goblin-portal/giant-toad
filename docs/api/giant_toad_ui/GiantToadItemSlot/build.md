...
If a widget's [build](../../giant_toad_ui/GiantToadItemSlot/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadItemSlot](../../giant_toad_ui/GiantToadItemSlot-class.md)
4.  build method

##### GiantToadItemSlot class
