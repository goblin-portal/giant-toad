...
# <span class="kind-method">write</span> abstract method
...
3.  [GiantToadStore](../../src_runtime_giant_toad_systems/GiantToadStore-class.md)
4.  write abstract method

##### GiantToadStore class
