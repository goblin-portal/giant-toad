...
<span class="returntype">dynamic</span> <span class="name">seek</span>({

1.  <span id="seek-param-position" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">position</span>, </span>
2.  <span id="seek-param-target" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">target</span>, </span>
...
4.  <span id="seek-param-output" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">output</span>, </span>
