...
If a subclass overrides the equality operator, it should override the [hashCode](../../giant_toad/GiantToadChunkKey/hashCode.md) method as well to maintain consistency.
