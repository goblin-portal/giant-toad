...
If a subclass overrides the equality operator, it should override the [hashCode](../../giant_toad/GiantToadAction/hashCode.md) method as well to maintain consistency.
