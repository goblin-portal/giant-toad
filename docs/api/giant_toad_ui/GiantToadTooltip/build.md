...
If a widget's [build](../../giant_toad_ui/GiantToadTooltip/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadTooltip](../../giant_toad_ui/GiantToadTooltip-class.md)
4.  build method
