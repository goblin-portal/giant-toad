...
1.  <span id="param-areas" class="parameter">required <span class="type-annotation">[List](https://api.flutter.dev/flutter/dart-core/List-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadMapArea](../../giant_toad/GiantToadMapArea-class.md)</span>\></span></span> <span class="parameter-name">areas</span>, </span>
