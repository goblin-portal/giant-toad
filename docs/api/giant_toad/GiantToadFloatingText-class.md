...
# <span class="kind-class">GiantToadFloatingText</span> class
...
- [TextComponent](https://pub.dev/documentation/flame/1.38.0/components/TextComponent-class.md)<span class="signature">\<<span class="type-parameter">[TextRenderer](https://pub.dev/documentation/flame/1.38.0/text/TextRenderer-class.md)</span>\></span>
...
<span class="name">[GiantToadFloatingText](../giant_toad/GiantToadFloatingText/GiantToadFloatingText.md)</span><span class="signature">({<span id="param-text" class="parameter">required <span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">text</span>, </span><span id="param-position" class="parameter">required <span class="type-annotation">[Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)?</span> <span class="parameter-name">position</span>, </span><span id="param-lifetime" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">lifetime</span> = <span class="default-value">0.7</span>, </span><span id="param-velocity" class="parameter"><span class="type-annotation">[Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)?</span> <span class="parameter-name">velocity</span>, </span><span id="param-textRenderer" class="parameter"><span class="type-annotation">[TextRenderer](https://pub.dev/documentation/flame/1.38.0/text/TextRenderer-class.md)?</span> <span class="parameter-name">textRenderer</span>, </span><span id="param-priority" class="parameter"><span class="type-annotation">[int](https://api.flutter.dev/flutter/dart-core/int-class.md)?</span> <span class="parameter-name">priority</span></span>})</span>  
...
<span class="name">[age](../giant_toad/GiantToadFloatingText/age.md)</span> <span class="signature">↔ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
<div>
...
<span class="name">[alive](../giant_toad/GiantToadFloatingText/alive.md)</span> <span class="signature">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
<div>
...
<span class="name">[lifetime](../giant_toad/GiantToadFloatingText/lifetime.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
<div>
...
<span class="name">[text](https://pub.dev/documentation/flame/1.38.0/components/TextComponent/text.md)</span> <span class="signature">↔ [String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>  
<div>
...
<span class="name">[textRenderer](https://pub.dev/documentation/flame/1.38.0/components/TextComponent/textRenderer.md)</span> <span class="signature">↔ [TextRenderer](https://pub.dev/documentation/flame/1.38.0/text/TextRenderer-class.md)</span>  
<div>
...
<span class="name">[velocity](../giant_toad/GiantToadFloatingText/velocity.md)</span> <span class="signature">→ [Vector2](https://pub.dev/documentation/vector_math/2.3.0/vector_math/Vector2-class.md)</span>  
<div>
...
<span class="name">[onChanged](https://pub.dev/documentation/flame/1.38.0/components/TextComponent/onChanged.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[update](../giant_toad/GiantToadFloatingText/update.md)</span><span class="signature">(<span id="update-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
