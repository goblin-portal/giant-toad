...
<span class="returntype">[GiantToadBehaviorResult](../../giant_toad/GiantToadBehaviorResult-class.md)</span> <span class="name">run</span>({
...
3.  <span id="run-param-inputs" class="parameter"><span class="type-annotation">[Iterable](https://api.flutter.dev/flutter/dart-core/Iterable-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadBehaviorInput](../../giant_toad/GiantToadBehaviorInput-class.md)<span class="signature">\<<span class="type-parameter">S</span>\></span></span>\></span></span> <span class="parameter-name">inputs</span> = <span class="default-value">const \[\]</span>, </span>
