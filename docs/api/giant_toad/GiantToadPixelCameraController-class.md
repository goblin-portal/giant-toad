...
# <span class="kind-class">GiantToadPixelCameraController</span> class
...
<span class="name">[GiantToadPixelCameraController](../giant_toad/GiantToadPixelCameraController/GiantToadPixelCameraController.md)</span><span class="signature">({<span id="param-camera" class="parameter">required <span class="type-annotation">[CameraComponent](https://pub.dev/documentation/flame/1.38.0/camera/CameraComponent-class.md)</span> <span class="parameter-name">camera</span>, </span><span id="param-target" class="parameter"><span class="type-annotation">[PositionComponent](https://pub.dev/documentation/flame/1.38.0/components/PositionComponent-class.md)?</span> <span class="parameter-name">target</span>, </span><span id="param-followSpeed" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">followSpeed</span> = <span class="default-value">12</span>, </span><span id="param-deadzone" class="parameter"><span class="type-annotation">[Rect](https://api.flutter.dev/flutter/dart-ui/Rect-class.md)</span> <span class="parameter-name">deadzone</span> = <span class="default-value">Rect.zero</span>, </span><span id="param-lookAhead" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">lookAhead</span> = <span class="default-value">0</span>, </span><span id="param-worldBounds" class="parameter"><span class="type-annotation">[Rect](https://api.flutter.dev/flutter/dart-ui/Rect-class.md)?</span> <span class="parameter-name">worldBounds</span>, </span><span id="param-pixelSnap" class="parameter"><span class="type-annotation">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> <span class="parameter-name">pixelSnap</span> = <span class="default-value">true</span>, </span><span id="param-maxShake" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">maxShake</span> = <span class="default-value">6</span></span>})</span>  
...
<span class="name">[camera](../giant_toad/GiantToadPixelCameraController/camera.md)</span> <span class="signature">→ [CameraComponent](https://pub.dev/documentation/flame/1.38.0/camera/CameraComponent-class.md)</span>  
<div>
...
<span class="name">[deadzone](../giant_toad/GiantToadPixelCameraController/deadzone.md)</span> <span class="signature">→ [Rect](https://api.flutter.dev/flutter/dart-ui/Rect-class.md)</span>  
<div>
...
<span class="name">[followSpeed](../giant_toad/GiantToadPixelCameraController/followSpeed.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
<div>
...
<span class="name">[lookAhead](../giant_toad/GiantToadPixelCameraController/lookAhead.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
<div>
...
<span class="name">[maxShake](../giant_toad/GiantToadPixelCameraController/maxShake.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
<div>
...
<span class="name">[pixelSnap](../giant_toad/GiantToadPixelCameraController/pixelSnap.md)</span> <span class="signature">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
<div>
...
<span class="name">[target](../giant_toad/GiantToadPixelCameraController/target.md)</span> <span class="signature">↔ [PositionComponent](https://pub.dev/documentation/flame/1.38.0/components/PositionComponent-class.md)?</span>  
<div>
...
<span class="name">[trauma](../giant_toad/GiantToadPixelCameraController/trauma.md)</span> <span class="signature">→ [double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span>  
<div>
...
<span class="name">[worldBounds](../giant_toad/GiantToadPixelCameraController/worldBounds.md)</span> <span class="signature">→ [Rect](https://api.flutter.dev/flutter/dart-ui/Rect-class.md)?</span>  
<div>
...
<span class="name">[addTrauma](../giant_toad/GiantToadPixelCameraController/addTrauma.md)</span><span class="signature">(<span id="addTrauma-param-amount" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">amount</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[update](../giant_toad/GiantToadPixelCameraController/update.md)</span><span class="signature">(<span id="update-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
3.  GiantToadPixelCameraController class
