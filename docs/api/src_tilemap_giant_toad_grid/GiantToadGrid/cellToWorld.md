...
<span class="returntype">dynamic</span> <span class="name">cellToWorld</span>({

1.  <span id="cellToWorld-param-cell" class="parameter">required <span class="type-annotation">dynamic</span> <span class="parameter-name">cell</span>, </span>
...
3.  <span id="cellToWorld-param-output" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">output</span>, </span>
