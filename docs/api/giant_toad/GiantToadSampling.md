...
<span class="name">pixelPerfect</span> <span class="signature">→ const [GiantToadSampling](../giant_toad/GiantToadSampling.md)</span>  
Integer placement and nearest-neighbor sampling.

<span class="name">crispTransform</span> <span class="signature">→ const [GiantToadSampling](../giant_toad/GiantToadSampling.md)</span>  
Fractional placement and arbitrary rotation with hard nearest edges.

<span class="name">smooth</span> <span class="signature">→ const [GiantToadSampling](../giant_toad/GiantToadSampling.md)</span>  
...
<span class="name">[values](../giant_toad/GiantToadSampling/values-constant.md)</span> <span class="signature">→ const [List](https://api.flutter.dev/flutter/dart-core/List-class.md)<span class="signature">\<<span class="type-parameter">[GiantToadSampling](../giant_toad/GiantToadSampling.md)</span>\></span></span>  
