...
# <span class="kind-class">GiantToadJoystickActions</span> class
...
<span class="name">[GiantToadJoystickActions](../giant_toad/GiantToadJoystickActions/GiantToadJoystickActions.md)</span><span class="signature">({<span id="param-joystick" class="parameter">required <span class="type-annotation">[JoystickComponent](https://pub.dev/documentation/flame/1.38.0/input/JoystickComponent-class.md)</span> <span class="parameter-name">joystick</span>, </span><span id="param-input" class="parameter">required <span class="type-annotation">[GiantToadActionInput](../giant_toad/GiantToadActionInput-class.md)</span> <span class="parameter-name">input</span></span>})</span>  
...
<span class="name">[input](../giant_toad/GiantToadJoystickActions/input.md)</span> <span class="signature">→ [GiantToadActionInput](../giant_toad/GiantToadActionInput-class.md)</span>  
<div>
...
<span class="name">[joystick](../giant_toad/GiantToadJoystickActions/joystick.md)</span> <span class="signature">→ [JoystickComponent](https://pub.dev/documentation/flame/1.38.0/input/JoystickComponent-class.md)</span>  
<div>
...
<span class="name">[onRemove](../giant_toad/GiantToadJoystickActions/onRemove.md)</span><span class="signature">() <span class="returntype parameter">→ void</span> </span>  
...
<span class="name">[update](../giant_toad/GiantToadJoystickActions/update.md)</span><span class="signature">(<span id="update-param-dt" class="parameter"><span class="type-annotation">[double](https://api.flutter.dev/flutter/dart-core/double-class.md)</span> <span class="parameter-name">dt</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
3.  GiantToadJoystickActions class
