...
If a widget's [build](../../giant_toad_ui/GiantToadToolbar/build.md) method is to depend on anything else, use a [StatefulWidget](https://api.flutter.dev/flutter/widgets/StatefulWidget-class.md) instead.
...
3.  [GiantToadToolbar](../../giant_toad_ui/GiantToadToolbar-class.md)
4.  build method

##### GiantToadToolbar class
