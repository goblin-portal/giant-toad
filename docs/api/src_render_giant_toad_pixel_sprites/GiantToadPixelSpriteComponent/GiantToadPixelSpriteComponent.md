...
1.  <span id="param-sprite" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">sprite</span>, </span>
...
8.  <span id="param-sampling" class="parameter"><span class="type-annotation">[GiantToadSampling](../../src_render_giant_toad_pixel_sprites/GiantToadSampling.md)?</span> <span class="parameter-name">sampling</span>, </span>
...
3.  [GiantToadPixelSpriteComponent](../../src_render_giant_toad_pixel_sprites/GiantToadPixelSpriteComponent-class.md)
