...
<span class="returntype">[GiantToadActionMap](../../src_input_giant_toad_actions/GiantToadActionMap-class.md)</span> <span class="name">decode</span>(
...
3.  [GiantToadActionMapCodec](../../src_input_giant_toad_actions/GiantToadActionMapCodec-class.md)
