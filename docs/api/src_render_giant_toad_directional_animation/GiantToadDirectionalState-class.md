...
# <span class="kind-class">GiantToadDirectionalState\<<span class="type-parameter">T</span>\></span> class
...
<span class="name">[GiantToadDirectionalState](../src_render_giant_toad_directional_animation/GiantToadDirectionalState/GiantToadDirectionalState.md)</span><span class="signature">({<span id="param-state" class="parameter">required <span class="type-annotation">T</span> <span class="parameter-name">state</span>, </span><span id="param-flipX" class="parameter"><span class="type-annotation">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span> <span class="parameter-name">flipX</span> = <span class="default-value">false</span></span>})</span>  
<div>
...
<span class="name">[flipX](../src_render_giant_toad_directional_animation/GiantToadDirectionalState/flipX.md)</span> <span class="signature">→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.md)</span>  
<div>
...
<span class="name">[state](../src_render_giant_toad_directional_animation/GiantToadDirectionalState/state.md)</span> <span class="signature">→ T</span>  
<div>
...
3.  GiantToadDirectionalState<span class="signature">\<<span class="type-parameter">T</span>\></span> class
