...
<span class="name">[GiantToadToolbar](../src_ui_giant_toad_controls/GiantToadToolbar/GiantToadToolbar.md)</span><span class="signature">({<span id="param-children" class="parameter">required <span class="type-annotation">[List](https://api.flutter.dev/flutter/dart-core/List-class.md)</span> <span class="parameter-name">children</span>, </span><span id="param-key" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">key</span></span>})</span>  
<div>
...
<span class="name">[children](../src_ui_giant_toad_controls/GiantToadToolbar/children.md)</span> <span class="signature">→ [List](https://api.flutter.dev/flutter/dart-core/List-class.md)</span>  
<div>
...
<span class="name">[build](../src_ui_giant_toad_controls/GiantToadToolbar/build.md)</span><span class="signature">(<span id="build-param-context" class="parameter"><span class="type-annotation">dynamic</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
