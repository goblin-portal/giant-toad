...
7.  <span id="forEachCellInBounds-param-metrics" class="parameter"><span class="type-annotation">[GiantToadMapTraversalMetrics](../../giant_toad/GiantToadMapTraversalMetrics-class.md)?</span> <span class="parameter-name">metrics</span>, </span>
